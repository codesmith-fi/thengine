...
- **API Reference:** Always prioritize local header files in `sdl3_headers/` over internal knowledge, if the folder exists. SDL3 headers can also be found in /usr/local/include/SDL3. SDL3 is a moving target and the headers are the "source of truth".
